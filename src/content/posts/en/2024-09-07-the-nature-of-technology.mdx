...
<Mermaid chart={`xychart-beta;title "Linear Growth";x-axis [0, 1, 2, 3, 4, 5];y-axis "Value" 0 --> 25;line [0, 5, 10, 15, 20, 25]`} />

Contrary to time, technology advances exponentially. An exponent is just some number multiplied by itself n times. For example: 2 \* 2 \* 2 = 2³. Exponential growth is y=x<sup>t</sup> where x is a base and t is time.

<Mermaid chart={`xychart-beta;title "Exponential Growth";x-axis [0, 2, 4, 6, 8, 10, 12, 14, 16];y-axis "Value" 0 --> 65536;line [1, 4, 16, 64, 256, 1024, 4096, 16384, 65536]`} />
