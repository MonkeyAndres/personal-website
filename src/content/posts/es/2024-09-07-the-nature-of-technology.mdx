...
<Mermaid chart={`xychart-beta;title "Crecimiento Lineal";x-axis [0, 1, 2, 3, 4, 5];y-axis "Valor" 0 --> 25;line [0, 5, 10, 15, 20, 25]`} />

A diferencia del tiempo, la tecnología avanza exponencialmente. Un exponente es solo un número multiplicado por sí mismo n veces. Por ejemplo: 2 \* 2 \* 2 = 2³. El crecimiento exponencial es y=x<sup>t</sup>, donde x es una base y t es el tiempo.

<Mermaid chart={`xychart-beta;title "Crecimiento Exponencial";x-axis [0, 2, 4, 6, 8, 10, 12, 14, 16];y-axis "Valor" 0 --> 65536;line [1, 4, 16, 64, 256, 1024, 4096, 16384, 65536]`} />
